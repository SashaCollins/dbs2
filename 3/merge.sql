...
CREATE OR REPLACE PROCEDURE get_staffnr(identify IN VARCHAR, source IN VARCHAR, staff_nr OUT INTEGER, exist OUT BOOLEAN)
IS  
	results INTEGER;
BEGIN
	...
	IF results = 0 THEN
		staff_nr := generate_id(6);
		exist := FALSE;
		INSERT INTO Identifier VALUES (staff_nr, source, identify);
	ELSE
